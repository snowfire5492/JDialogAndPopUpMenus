...
class PopupMenuDemo implements ActionListener {
    ...
    PopupMenuDemo() {
        ...
        // Create a label that will dislay the menu selection. 
        jlab = new JLabel();
        ...
        jmColors.setMnemonic('c');
        JMenuItem jmiRed = new JMenuItem("Red", 'r');
        JMenuItem jmiGreen = new JMenuItem("Green", 'g');
        JMenuItem jmiBlue = new JMenuItem("Blue", 'b');
        jmColors.add(jmiRed);
        ...
        JMenuItem jmiBlack = new JMenuItem("Black", 'k');
